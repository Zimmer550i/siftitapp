      ...
      children: [
        if (widget.title != null)
          Padding(
            ...
            child: Text(widget.title!, style: AppTexts.tsms),
          ),
        GestureDetector(
          onTap: () {
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: isFocused
                  ...
                  : Border.all(color: AppColors.zinc.shade100),
            ),
            child: Row(
              spacing: 12,
                ...
                if (widget.leading != null)
                  SvgPicture.asset(
                    ...
                    colorFilter: ColorFilter.mode(
                      isFocused ? AppColors.teal : AppColors.teal.shade100,
                      BlendMode.srcIn,
                    ),
                  ),
                Expanded(
                ...
                if (widget.isPassword)
                  GestureDetector(
                    ...
                    child: SvgPicture.asset(
                      ...
                      width: 20,
                      colorFilter: ColorFilter.mode(
                        isFocused ? AppColors.teal : AppColors.zinc.shade100,
                        BlendMode.srcIn,
                      ),
                    ),
                  ),
