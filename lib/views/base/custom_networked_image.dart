    ...
    return ClipRRect(
      ...
      child: file != null
          ...
          ? Container(
              height: height,
              width: width,
              decoration: BoxDecoration(color: AppColors.zinc.shade200),
          ...
          : CachedNetworkImage(
                ...
                return Container(
                  ...
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.error, color: AppColors.zinc.shade400),
                        Expanded(
                          child: Text(
                            error.toString(),
              ...
              placeholder: (context, url) {
                return Shimmer.fromColors(
                  baseColor: AppColors.teal.shade300,
                  highlightColor: AppColors.teal[25]!,
